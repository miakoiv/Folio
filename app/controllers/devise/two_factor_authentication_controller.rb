# This is identical to the controller supplied by two_factor_authentication,
# except compatibility code for Devise versions prior to 4.2.0 has been
# removed. For some reason the check for Devise version fails in Rails 5.0.
#
